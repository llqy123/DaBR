...
parser.add_argument("--dataset", default="WN18", help="Name of the dataset.")
...
parser.add_argument("--num_epochs", default=40000, type=int, help="Number of training epochs")
parser.add_argument("--model_name", default='DaBR', help="")
parser.add_argument('--neg_num', default=5, type=int, help='')
parser.add_argument('--hidden_size', type=int, default=300, help='')
parser.add_argument('--save_steps', type=int, default=400, help='')
parser.add_argument('--valid_steps', type=int, default=400, help='')
parser.add_argument("--lmbda", default=0.05, type=float, help="")
...
if args.model_name is None or len(args.model_name.strip()) == 0:
    args.model_name = "{}_lda-{}_nneg-{}_hs-{}_lr-{}_nepochs-{}".format(args.dataset,
                                                                        ...
                                                                        args.num_epochs)
print(args)
out_dir = os.path.abspath(os.path.join("Logs/WN18/"))
print("Writing to {}\n".format(out_dir))
