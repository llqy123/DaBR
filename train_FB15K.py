...
parser.add_argument("--dataset", default="FB15K", help="Name of the dataset.")
...
parser.add_argument('--save_steps', type=int, default=100000, help='')
parser.add_argument('--valid_steps', type=int, default=200, help='')
...
if args.model_name is None or len(args.model_name.strip()) == 0:
    args.model_name = "{}_lda-{}_nneg-{}_hs-{}_lr-{}_nepochs-{}".format(args.dataset,
                                                                        ...
                                                                        args.num_epochs)
print(args)
out_dir = os.path.abspath(os.path.join("Logs/FB15K/"))
print("Writing to {}\n".format(out_dir))
